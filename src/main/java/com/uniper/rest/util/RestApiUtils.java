...
import com.uniper.tableau.bindings.CapabilityType;
import com.uniper.tableau.bindings.FileUploadType;
import com.uniper.tableau.bindings.GranteeCapabilitiesType;
import com.uniper.tableau.bindings.GroupType;
import com.uniper.tableau.bindings.ObjectFactory;
import com.uniper.tableau.bindings.PermissionsType;
import com.uniper.tableau.bindings.ProjectListType;
import com.uniper.tableau.bindings.ProjectType;
import com.uniper.tableau.bindings.SiteListType;
import com.uniper.tableau.bindings.SiteType;
import com.uniper.tableau.bindings.TableauCredentialsType;
import com.uniper.tableau.bindings.TsRequest;
import com.uniper.tableau.bindings.TsResponse;
...
public class RestApiUtils {
    ...
    private enum Operation {
        ...
        DOWNLOAD_WORKBOOK(getApiUriBuilder().path("sites/{siteId}/workbooks/{workbookId}/content")),
    ...
    private static UriBuilder getApiUriBuilder() {
        return UriBuilder.fromPath(m_properties.getProperty("server.host") + "/api/2.1");
    }
    /**
    ...
    private static void initialize() {
        try {
            ...
            m_properties.load(new FileInputStream("config.properties"));
            ...
            throw new IllegalStateException("Failed to initialize the REST API " + ex.getMessage() + " " + System.getProperty("user.dir"));
        }
    }
     ...
     *         <code>null</code>
     */
    public void downloadWorkbook(TableauCredentialsType credential, String siteId,
            String workbookId,String filePath) {
        ...
        get(url, credential.getToken(), filePath);
        // Creates the payload used to add permissions
    ...
    private void get(String url, String authToken, String filepath) {
		CloseableHttpClient httpclient = HttpClients.createDefault();
		//String uri = "http://sm10094.dom1.e-ssi.net/api/2.1/sites/97546d38-4a02-4d44-a1f4-c811f6787ea3/workbooks/387de39d-062c-4a1a-8f0e-255563b47730/content";
		HttpGet httpget = new HttpGet(url);
		//String token = "W39OS8On0F5D4WTTJ2YQwIswt8p3QqWi";
		String key = "X-Tableau-Auth";
		httpget.addHeader(key, authToken);
		
		try {
			/*File fx = new File(filepath);
			ResponseBuilder responseBuilder = RestApiUtils.ok;*/
			HttpEntity entity;
			HttpResponse response = httpclient.execute(httpget);
			//response.h
			entity = response.getEntity();
			BufferedInputStream bis = new BufferedInputStream(entity.getContent());
			//String filepath = "target/sample.twbx";
    ...
    public WorkbookListType invokeQueryWorkbooks(TableauCredentialsType credential, String siteId, String userId) {
        ...
        // Makes a GET request with the authenticity token
        TsResponse response = get(url, credential.getToken());
        m_logger.info("Querying URL : " + url);
